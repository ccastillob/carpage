    ...
    <>
      ...
      <SkeletonTheme baseColor="#8e8e8f">
        <main className="main-container maintenancepage">
            ...
            <article className="ed-grid article__banner m-grid-2">
              <div className="banner__content m-cols-1">
                ...
                <div className="container-services pt-20 ed-grid col-gap-32 s-grid-6 row-gap-4">
                  {Array(dataArrBasicLength)
                    .fill()
                    .map((basicDetails, index) => (
                      <div
                        key={index}
                        className="services__list s-cross-center s-cols-3"
                      >
                        <Skeleton
                          className="container-icon s-mr-2"
                          width={10}
                        />
                ...
                <div className="container-buttons mt-32">
                  <Skeleton
                    className="button button-ghost mr-32"
                    width={100}
                    height={30}
                  />
                  <Skeleton
          ...
          <section className="section-banner border-section">
            <div
              className="skeleton_bg_maintenance"
              height={`100%`}
              width={`100%`}
            />
            <article className="ed-grid article__banner m-grid-2">
              <div className="banner__content m-cols-1 m-x-2">
                ...
                <div className="container-services pt-20 ed-grid col-gap-32 s-grid-6 row-gap-4">
                  {Array(dataArrAdvancedLength)
                    .fill()
                    .map((advancedDetails, index) => (
                      <div
                        key={index}
                        className="services__list s-cross-center s-cols-3"
                      >
