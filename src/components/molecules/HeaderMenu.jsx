          ...
          <div className="s-to-right s-cross-center">
            <div className="menu-container m-main-center m-pr-4">
              <NavLink to="/" className="m-py-1 m-px-2 m-mr-2 menu-list">
                <h4
                  className={`${status === 'home' && 'active'} content-color`}
                >
                  Bienvenido
                </h4>
              </NavLink>
              <NavLink to="/models" className="m-py-1 m-px-2 m-mr-2 menu-list">
                <h4
                  className={`${status === 'model' && 'active'} content-color`}
                >
                  Modelos
                </h4>
              </NavLink>
              <NavLink
                to="/maintenances"
                className="m-py-1 m-px-2 m-mr-2 menu-list"
              >
                <h4
                  className={`${
              ...
              <NavLink to="/events" className="m-py-1 m-px-2 menu-list">
                <h4
                  className={`${status === 'event' && 'active'} content-color`}
                >
                  Eventos
                </h4>
              </NavLink>
